...
//
// ============================================================================
//  Autonomous Warehouse Robot Fleet MAPF 10x Extreme Benchmark
// ============================================================================
//
//  Models dynamic spatio-temporal pathfinding for 6 Autonomous Mobile Robots (AMRs)
//  navigating a 6x6 grid warehouse floor over an 8-tick operational horizon.
//
//  Hard CNF Scale:
//  - 6 Autonomous Mobile Robots (AMRs)
//  - 6x6 Grid Workspace (36 spatial cells)
//  - 8 Time Ticks
//  - 1,728 Logical Decision Variables
//  - ~150,000 Pure CNF Clauses
...
//  - Start Depots at t=0 and Workstation Target Goals at t=7
//
// ============================================================================

module warehouse_mapf_10x_extreme;
...
enum GRID_DIM = 6;
enum NUM_CELLS = GRID_DIM * GRID_DIM; // 36 cells
enum NUM_ROBOTS = 6;
enum NUM_TICKS = 8;
...
RobotRouteConfig[NUM_ROBOTS] getRobotConfigs() {
    return [
        RobotRouteConfig(0, 0, 3, 4),
        RobotRouteConfig(1, 0, 4, 3),
        RobotRouteConfig(2, 0, 5, 2),
...
void main() {
    writeln("==========================================================================");
    writeln("  Autonomous Warehouse Robot Fleet MAPF 10x Extreme Benchmark");
    writeln("==========================================================================");
    ...
    auto model = new Model("warehouse-mapf-10x-extreme");
