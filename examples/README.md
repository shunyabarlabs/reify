...
| **Market Structure Routing** | [`hft_orderbook_arbitrage.d`](d/hft_orderbook_arbitrage.d) | 1,440 | 4,321 | **14,975** | **14,975 / 14,975** | **Optimal** | Routing & consistency model inspired by market structure across 6 venues, 100% SAT in 0.139s |
| **Real Crypto Arbitrage Solver** | [`real_crypto_arbitrage_solver.d`](d/real_crypto_arbitrage_solver.d) | 20 | 20 | **20** | **20 / 20** | **Optimal** | Real multi-exchange orderbook scanning, fee & spread calculations, profit route execution |
